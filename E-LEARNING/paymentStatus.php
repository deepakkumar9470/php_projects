...
?>
 ...
 <!--*********** Course Page Banner *************--> 
  ...
  <div class="container-fluid bg-dark">
      <div class="row">
          <img src="Images/payment1.jpg" alt="course image" style="height:500px; width:100%; object-fit:cover;
          box-shadow:10px;">
      </div>
  </div>
        ...
        <div class="container">
	     ...
	     <form method="post" action="">
		   <div class="form-group row">
			   ...
			   <div>
			       <input id="ORDER_ID" class="from-control mx-3" tabindex="1" maxlength="20" size="20" name="ORDER_ID" autocomplete="off" value="<?php echo $ORDER_ID ?>">
			   </div>
				<div>
